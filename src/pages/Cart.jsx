        ...
        <div className="space-y-4">
          {cartProducts && cartProducts.map((item) => (
            <motion.div
              ...
              className="relative flex items-center bg-[var(--bg-secondary)] border border-[var(--bg-tertiary)] rounded-lg p-4 gap-4"
            >
              {/* Cancel Button */}
              <button
              ...
              <div className="flex-1">
                ...
                <div className="text-[var(--text-tertiary)] text-sm">Qty: {item.quantity}</div>
              </div>
